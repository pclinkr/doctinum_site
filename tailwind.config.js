    ...
    extend: {
      ...
      keyframes: {
        ...
        lsLogoOut: {
          ...
          '100%': {
            opacity: '0',
            transform: 'translate3d(0,-120vh,0) scale(.92)',
          },
        },
        lsBarOut: {
      ...
      animation: {
        ...
        // Loading screen animations
        lsContentIntro:
          'lsContentIntro 0.82s cubic-bezier(.28,.02,.21,1) forwards',
        curtainLift: 'curtainLift 0.6s cubic-bezier(.28,.02,.21,1) forwards',
        lsContentExit:
          'lsContentExit .82s cubic-bezier(.28,.02,.21,1) forwards',
        ...
        // Page transition animations
        pageLoaderReveal:
          'pageLoaderReveal .9s cubic-bezier(.22,.61,.36,1) .18s both',
