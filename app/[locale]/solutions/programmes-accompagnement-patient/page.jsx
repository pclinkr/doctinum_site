...
export async function generateMetadata({ params }) {
  ...
  const seoValue = getSeoForPage('patient-support-programs', localeCode);
  return {
...
export default function PatientSupportProgramsRoute() {
  return <PageRenderer pageId="patient-support-programs" />;
}
