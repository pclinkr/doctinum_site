...
export async function generateMetadata({ params }) {
  ...
  const seoValue = getSeoForPage('prevention-workplace-health', localeCode);
  return {
...
export default function PreventionWorkHealthRoute() {
  return <PageRenderer pageId="prevention-workplace-health" />;
}
