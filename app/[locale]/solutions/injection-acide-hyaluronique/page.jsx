...
export async function generateMetadata({ params }) {
  ...
  const seoValue = getSeoForPage('surgery-hyaluronic-injection', localeCode);
  return {
...
export default function HyaluronicInjectionRoute() {
  return <PageRenderer pageId="surgery-hyaluronic-injection" />;
}
