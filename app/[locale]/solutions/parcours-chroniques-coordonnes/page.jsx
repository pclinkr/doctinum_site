...
export async function generateMetadata({ params }) {
  ...
  const seoValue = getSeoForPage('coordinated-chronic-pathways', localeCode);
  return {
...
export default function CoordinatedChronicPathwaysRoute() {
  return <PageRenderer pageId="coordinated-chronic-pathways" />;
}
