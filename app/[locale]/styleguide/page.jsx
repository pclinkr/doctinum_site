...
const colorTokens = [
  ...
  { label: 'Surface Alt', variable: '--bg-surface-2' },
    ...
    <section style={{ marginBottom: '34px' }}>
      <Card style={{ padding: '24px' }}>
        <div style={{ marginBottom: '18px', display: 'grid', gap: '8px' }}>
          ...
          {description ? (
            <p className="ds-text-body" style={{ color: 'var(--text-muted)', maxWidth: '70ch' }}>{description}</p>
          ) : null}
        </div>
        {children}
      </Card>
  ...
  return (
    <main style={{ paddingTop: 'calc(var(--layout-nav-h) + 48px)', paddingInline: '64px', paddingBottom: '72px', maxWidth: '1200px', marginInline: 'auto' }}>
      <section style={{ marginBottom: '34px' }}>
        ...
        <h1 className="ds-text-h1" style={{ marginTop: '16px' }}>Style Guide</h1>
        <p className="ds-text-body" style={{ color: 'var(--text-muted)', maxWidth: '68ch', marginTop: '12px' }}>
      ...
      >
        <div style={{ display: 'grid', gap: '16px' }}>
          <h1 className="ds-text-h1" style={{ fontSize: '52px' }}>Heading 1 - ds-text-h1</h1>
          <h2 className="ds-text-h2">Heading 2 - ds-text-h2</h2>
          <h3 className="ds-text-h3">Heading 3 - ds-text-h3</h3>
          <h4 className="ds-text-h4">Heading 4 - ds-text-h4</h4>
          <p className="ds-text-body">Body text - ds-text-body. The quick brown fox jumps over the lazy dog.</p>
          <p className="ds-text-label">Label text - ds-text-label</p>
        </div>
      </SectionBlock>
      ...
      >
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: '16px' }}>
          <Card style={{ padding: '20px' }}>
            <h3 className="ds-text-h4">Feature Card</h3>
            <p className="ds-text-body" style={{ marginTop: '8px', color: 'var(--text-muted)' }}>Reusable card with semantic tokens.</p>
          </Card>
          <Card style={{ padding: '20px' }}>
            <h3 className="ds-text-h4">Content Card</h3>
            <p className="ds-text-body" style={{ marginTop: '8px', color: 'var(--text-muted)' }}>Use Card for consistent surfaces and radius.</p>
          </Card>
          <Card style={{ padding: '20px' }}>
            <h3 className="ds-text-h4">Stat Card</h3>
            <p className="ds-text-body" style={{ marginTop: '8px', color: 'var(--text-muted)' }}>Edit tokens once, update all cards.</p>
          </Card>
        </div>
      </SectionBlock>
