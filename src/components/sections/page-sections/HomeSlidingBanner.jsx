  ...
  return (
    <Container 
      ...
      style={{
        ...
        backgroundImage: 'var(--gradient-rollup-banner-rail),var(--gradient-rollup-banner-rail)',
    ...
    >
      ...
      >
        {duplicatedItems.map((item, index) => (
          <span key={`item-${index}`} className="text-[15px] font-[var(--w500)] tracking-[var(--track-tight)] text-[var(--subtle)] whitespace-nowrap flex items-center gap-5 rollup-banner-item">
            {item}
          </span>
        ))}
      </div>
