  ...
  return (
    <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--r-md)] border border-[var(--border)] bg-[linear-gradient(160deg,#f6f9ff_0%,#eef4ff_46%,#f8fbff_100%)]">
      ...
      >
        ...
        <path
          d="M52 268 C106 246, 132 210, 188 192 C238 176, 278 152, 330 136 C374 123, 424 110, 472 96"
          fill="none"
          stroke="rgba(17,36,63,0.78)"
          strokeWidth="3"
          strokeLinecap="round"
        />
        <path
          d="M52 232 C108 214, 156 206, 210 194 C266 184, 320 170, 380 154 C420 144, 450 138, 472 134"
          fill="none"
          stroke="rgba(90,130,198,0.68)"
          strokeWidth="2.4"
          strokeLinecap="round"
          strokeDasharray="4 6"
        />
        <path
          d="M52 182 C110 170, 164 176, 220 170 C278 164, 334 156, 392 150 C426 148, 452 146, 472 142"
          fill="none"
          stroke="rgba(131,149,178,0.8)"
          strokeWidth="2.2"
          strokeLinecap="round"
        />
      </svg>
