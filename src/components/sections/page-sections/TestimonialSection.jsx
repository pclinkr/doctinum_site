...
export default function TestimonialSection({ 
  ...
  return (
    <section className={`rev mx-auto w-full max-w-[1200px] px-16 py-24 max-[1024px]:px-8 max-[768px]:px-5 ${className}`}>
          ...
          {showQuote && (
            <>
              ...
              <p className="mb-5 text-[clamp(17px,2.5vw,22px)] font-[var(--w500)] leading-[1.45] tracking-[-0.04em]">
                {quotePrefix && `${quotePrefix} `}{quoteAccent && <em>{quoteAccent}</em>}{quote && ` ${quote}`}
              </p>
            </>
          )}
