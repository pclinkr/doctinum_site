        ...
        <div className="relative rounded-[var(--r-md)] bg-[var(--surface)] p-8">
          ...
          <div className="space-y-2 mb-6">
            {leftList.map((item) => (
              <div
                key={item}
                className="flex items-center gap-[10px] py-2 text-[14px] text-[var(--muted)]"
              >
          ...
          <div className="border-t border-[var(--border)] pt-4">
            <p className="mb-3 text-[14px] text-[var(--muted)]">
              {copy.leftBottomIntro}
            </p>
            {leftBottom.map((item) => (
              <div
                key={item}
                className="flex items-center gap-[10px] py-2 text-[14px] text-[var(--color-primary)]"
              >
