  ...
  return (
    <ul className="mt-4 space-y-3">
      {items.map((item) => (
        <li
          key={item}
          className="flex items-start gap-3 text-[14px] leading-[1.72] text-[var(--color-primary)]"
        >
  ...
  return (
    <Container className="py-16">
      <Card className="rev rounded-[26px] border border-[var(--border)] bg-[var(--surface)] p-10 max-[809px]:p-6">
        ...
        <h2 className="max-w-[24ch] text-[clamp(30px,4.2vw,54px)] leading-[1.03] tracking-[-0.05em]">
          {title}
        </h2>
