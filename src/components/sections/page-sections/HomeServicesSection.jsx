  ...
  return (
    <section className="mx-auto w-full max-w-[1200px] px-16 py-24 text-center max-[1024px]:px-8 max-[768px]:px-5">
      <SectionHeading
        ...
        title={
          <>
            {t('sections.services.titlePrefix')}{' '}
            <span className="si">{t('sections.services.titleAccent')}</span>
          </>
        }
      ...
      <div className="grid grid-cols-3 gap-5 text-left max-[809px]:grid-cols-1">
        {items.map((item) => (
          ...
          >
            <div
              className="mb-1 flex h-[150px] w-full items-center justify-center rounded-[var(--r-sm)] text-[42px]"
