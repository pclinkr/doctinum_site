  ...
  return (
    <Container className="grid grid-cols-2 items-start gap-16 pb-20 max-[809px]:grid-cols-1">
      ...
      <Card className="rev relative p-12">
        <div className="radius-xl absolute -top-6 left-6 flex h-[52px] w-[52px] items-center justify-center bg-[var(--ink-08)]"><BrandIcon stroke="var(--text-primary)" width={24} height={24} /></div>
