...
export default function HomeCasesSection({ onNavigate }) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <p className="ds-text-label mb-3">{t('sections.homeCases.label')}</p>
          <h2 className="text-[var(--color-primary)]">
            {t('sections.homeCases.titlePrefix')}{' '}
            <span className="si">{t('sections.homeCases.titleAccent')}</span>
          </h2>
        </div>
        <Button
          variant="outline"
        ...
        kpis={[
          {
            target: 128,
            suffix: 'K',
            label: t('sections.homeCases.case1.kpi1'),
          },
          {
            target: 245,
            suffix: '%',
            label: t('sections.homeCases.case1.kpi2'),
          },
        ]}
      />
      <CaseRow
        ...
        kpis={[
          {
            target: 18,
            suffix: 'K',
            label: t('sections.homeCases.case2.kpi1'),
          },
          {
            target: 156,
            suffix: '%',
            label: t('sections.homeCases.case2.kpi2'),
          },
        ]}
      />
    </section>
