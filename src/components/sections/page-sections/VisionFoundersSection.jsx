    ...
    <section className="py-[clamp(56px,7vw,110px)]">
      <Container>
        <div className="mx-auto max-w-[1000px]">
          ...
          <h2 className="rev mb-6 font-serif text-[clamp(1.9rem,3.2vw,2.8rem)] font-[600] leading-[1.16] tracking-[-0.02em]">
            {title}
          </h2>
          ...
          <div className="flex flex-col gap-16">
            {founders.map((founder, index) => {
              const founderImage =
                index === 0 ? 'michael_gravure.png' : 'regis_gravure.png';

              return (
                <div
                  key={index}
                  className="rev relative overflow-hidden rounded-[20px] border border-color-border bg-color-white p-10"
                >
                  ...
                  <div className="relative z-10">
                    <p className="mb-2 text-[12px] font-[var(--w500)] uppercase tracking-[0.16em] text-color-primary">
                      {founder.role}
                    </p>
                    ...
                    <div className="mb-6 flex flex-col gap-4">
                      {founder.story.map((paragraph, pIndex) => (
                        <p
                          key={pIndex}
                          className="text-[17px] font-light leading-[1.8] text-ink-68"
