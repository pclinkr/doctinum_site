        ...
        <div className="mx-auto max-w-[1000px]">
          ...
          <div className="flex flex-col gap-16">
            {founders.map((founder, index) => (
              <div
                key={index}
                className="rev relative border border-color-border bg-white p-10"
              >
                ...
                {founder.insight && (
                  <div className="mt-6 border-l-2 border-color-primary bg-color-surface px-5 py-5 font-serif italic leading-[1.6]">
                    "{founder.insight}"
                  </div>
                )}
              </div>
