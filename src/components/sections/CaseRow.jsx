      ...
      >
        ...
        <div className="flex flex-wrap gap-7">
          {kpis.map((kpi) => (
            <div key={kpi.label}>
              <div
                className="text-[28px] leading-none tracking-[-0.06em] tabular-nums font-[var(--w500)]"
                data-target={kpi.target}
                data-suffix={kpi.suffix}
              >
                0{kpi.suffix}
              </div>
              <div className="mt-1 text-[11px] font-[var(--w500)] uppercase tracking-[0.06em] text-[var(--muted)]">
                {kpi.label}
              </div>
            </div>
          ))}
