...
export default function HyaluronicInjectionPage({ active, onNavigate }) {
  const { t } = useTranslation();
  const ctaSubtitleFull = getCtaSubtitleFull(t);
  const copy = t('pages.solutions.hyaluronicInjection', {
    returnObjects: true,
  });

  return (
    <div
      id="page-hyaluronic-injection"
    ...
    >
      <SolutionHeroSection
        ...
        backButtonText="← Liposuccion"
        backButtonPage="surgery-liposuction"
        nextButtonText="Médecine du sport →"
        nextButtonPage="sports-medicine"
        backgroundImage="/assets/images/injection.png"
        backgroundType="image"
        showOverlayText={true}
        showOverlayImage={true}
        overlayGradientImage="var(--gradient-accent-cool-overlay)"
      />

      <TestimonialSection
        quote={copy.statement}
        showVisual={true}
        visualImageUrl="/assets/images/injection.png"
        showAuthor={false}
      />
